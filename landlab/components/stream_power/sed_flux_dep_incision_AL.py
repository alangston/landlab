        ...
        if self._Qc == "MPM":
            ...
            while 1:
                ...
                if "sediment__flux_from_lat" in grid.at_node:
                    sed_into_node = self._grid.at_node["sediment__flux_from_lat"]#/dt_this_step
                    #ALL: ^July 28, 2020: here I made sed_into_node units of m**3/s<--WRONG
                    #I was right that sed into node has to be in volume per dt.
                ...
                try:
                    ...
                    for i in s_in[::-1]:  # work downstream
                        ...
                        if sed_flux_into_this_node < node_vol_capacity:
                            ...
                            #^ ALL Dec31: Note that dz_prefactor is the max erosion in teh timestep
                            debug2=0
                            if debug2:
...
#        print("sed_into_node, vertical line1090")
#        print(sed_into_node)
